...
export async function POST(req: Request) {
  ...
  try {
    ...
    return Response.json({ data: API_MESSAGES.BEARER_TOKEN_NOT_VALID, code: API_CODES.INVALID_TOKEN } as BudioApiResponse<string>, { status: 400 })
  }
  ...
  try {
    ...
    return Response.json({ data: API_MESSAGES.BAD_REQUEST_BODY_FORMAT, code: API_CODES.WARNING } as BudioApiResponse<string>, { status: 400 })
  }
